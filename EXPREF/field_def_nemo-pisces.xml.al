    ...
    -->
     ...
     <field_group id="diad_T" grid_ref="grid_T_2D">
      ...
      <field id="FESCAV"      long_name="Scavenging of Iron"                      unit="mmol-Fe/m3/s"   grid_ref="grid_T_3D" />
       ...
       <field id="LNN"      long_name="N limitation term in Nanophyto"   unit=""           grid_ref="grid_T_3D" />
       <field id="LDN"      long_name="N limitation term in Diatoms"   unit=""           grid_ref="grid_T_3D" />
       <field id="LNP"      long_name="P limitation term in Nanophyto"   unit=""           grid_ref="grid_T_3D" />
       <field id="LDP"      long_name="P limitation term in Diatoms"   unit=""           grid_ref="grid_T_3D" />
       <field id="QFePSN"      long_name="Photosyn. contrib. to Nano Fe min"       unit="mol/mol"    grid_ref="grid_T_3D" />
       <field id="QFeNO3N"     long_name="Nitrate . contrib. to Nano Fe min"       unit="mol/mol"    grid_ref="grid_T_3D" />
       <field id="QFeRESN"     long_name="Respirat. contrib. to Nano Fe min"       unit="mol/mol"    grid_ref="grid_T_3D" />
       <field id="QFePSD"      long_name="Photosyn. contrib. to Diat Fe min"       unit="mol/mol"    grid_ref="grid_T_3D" />
       <field id="QFeNO3D"     long_name="Nitrate . contrib. to Diat Fe min"       unit="mol/mol"    grid_ref="grid_T_3D" />
       <field id="QFeRESD"     long_name="Respirat. contrib. to Diat Fe min"       unit="mol/mol"    grid_ref="grid_T_3D" />
       <field id="MLD"     long_name="Mixed layer depth"       unit="m" />
       <field id="LPN"      long_name="N limitation term in Picophyto"   unit=""           grid_ref="grid_T_3D" />
       <field id="QFeNO3P"     long_name="Nitrate . contrib. to Picophyto Fe min"       unit="mol/mol"    grid_ref="grid_T_3D" />
       <field id="QFeRESP"     long_name="Respirat. contrib. to Picophyto Fe min"       unit="mol/mol"    grid_ref="grid_T_3D" />
       <field id="QFePSP"      long_name="Photosyn. contrib. to Picophyto Fe min"       unit="mol/mol"    grid_ref="grid_T_3D" />
       <field id="QFEMAXN"      long_name="Computed QFemax nano"      unit="mol/mol"    grid_ref="grid_T_3D" />
       <field id="QFEMAXD"      long_name="Computed QFemax diatom"      unit="mol/mol"    grid_ref="grid_T_3D" />
       <field id="QFEMAXP"      long_name="Computed QFemax picophyto"      unit="mol/mol"    grid_ref="grid_T_3D" />
